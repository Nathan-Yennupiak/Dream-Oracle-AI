        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <textarea
              ...
              rows="5"
              className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-600 text-black text-sm"
              required
            />
          </div>
